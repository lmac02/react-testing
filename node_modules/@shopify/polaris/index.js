...
var POLARIS_ICONS = _interopDefault(require('@shopify/polaris-icons'));
...
function createDarkColor(color, darkness, saturation) {
  var darkenedColor = darkenColor(color, darkness);
  var saturatedColor = saturateColor(darkenedColor, saturation);
...
var darkenToString = compose$1(hslToString, createDarkColor);
...
function setTheme(color, baseName, key, variant) {
  ...
  switch (variant) {
    case 'light':
      ...
      colorPairs.push([constructColorName(baseName, key, 'darker'), darkenToString(color, 0, 0)]);
    ...
    case 'dark':
      ...
      colorPairs.push([constructColorName(baseName, key, 'darker'), darkenToString(color, 5, 5)]);
...
var add = POLARIS_ICONS.add;
var alert = POLARIS_ICONS.alert;
var arrowDown = POLARIS_ICONS.arrowDown;
var arrowLeft = POLARIS_ICONS.arrowLeft;
var arrowRight = POLARIS_ICONS.arrowRight;
var arrowUp = POLARIS_ICONS.arrowUp;
var arrowUpDown = POLARIS_ICONS.arrowUpDown;
var calendar = POLARIS_ICONS.calendar;
var cancel = POLARIS_ICONS.cancel;
var cancelSmall = POLARIS_ICONS.cancelSmall;
var caretDown = POLARIS_ICONS.caretDown;
var caretUp = POLARIS_ICONS.caretUp;
var checkmark = POLARIS_ICONS.checkmark;
var chevronDown = POLARIS_ICONS.chevronDown;
var chevronLeft = POLARIS_ICONS.chevronLeft;
var chevronRight = POLARIS_ICONS.chevronRight;
var chevronUp = POLARIS_ICONS.chevronUp;
var circleCancel = POLARIS_ICONS.circleCancel;
var circleChevronDown = POLARIS_ICONS.circleChevronDown;
var circleChevronLeft = POLARIS_ICONS.circleChevronLeft;
var circleChevronRight = POLARIS_ICONS.circleChevronRight;
var circleChevronUp = POLARIS_ICONS.circleChevronUp;
var circleInformation = POLARIS_ICONS.circleInformation;
var circlePlus = POLARIS_ICONS.circlePlus;
var circlePlusOutline = POLARIS_ICONS.circlePlusOutline;
var conversation = POLARIS_ICONS.conversation;
var deleteIcon = POLARIS_ICONS.deleteIcon;
var disable = POLARIS_ICONS.disable;
var dispute = POLARIS_ICONS.dispute;
var duplicate = POLARIS_ICONS.duplicate;
var ellipsis = POLARIS_ICONS.ellipsis;
var embed = POLARIS_ICONS.embed;
var exportIcon = POLARIS_ICONS.exportIcon;
var external = POLARIS_ICONS.external;
var help = POLARIS_ICONS.help;
var home = POLARIS_ICONS.home;
var horizontalDots = POLARIS_ICONS.horizontalDots;
var importIcon = POLARIS_ICONS.importIcon;
var logOut = POLARIS_ICONS.logOut;
var menu = POLARIS_ICONS.menu;
var notes = POLARIS_ICONS.notes;
var notification = POLARIS_ICONS.notification;
var onlineStore = POLARIS_ICONS.onlineStore;
var orders = POLARIS_ICONS.orders;
var print = POLARIS_ICONS.print;
var products = POLARIS_ICONS.products;
var profile = POLARIS_ICONS.profile;
var subtract = POLARIS_ICONS.subtract;
var refresh = POLARIS_ICONS.refresh;
var risk = POLARIS_ICONS.risk;
var save = POLARIS_ICONS.save;
var search = POLARIS_ICONS.search;
var view = POLARIS_ICONS.view;
...
function Button(_ref) {
  ...
  var childMarkup = children ? React.createElement("span", null, children) : null;
...
function Section(_ref) {
  var children = _ref.children,
      ...
      fullWidth = _ref.fullWidth;
  var headerContent = title ? React.createElement("div", {
    className: styles$8.SectionHeader
  }, React.createElement(Subheading, null, title)) : null;
...
function Section$1(_ref) {
  ...
  var className = section.title ? null : styles$g['Section-withoutTitle'];
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      var _a = this.props,
          ...
          active = _a.active,
          fixed = _a.fixed,
          rest = tslib_1.__rest(_a, ["activatorWrapper", "children", "onClose", "activator", "activatorWrapper", "active", "fixed"]);
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$q.TextField, Boolean(value) && styles$q.hasValue, disabled && styles$q.disabled, readOnly && styles$q.readOnly, error && styles$q.error, multiline && styles$q.multiline, this.state.focus && styles$q.focus);
      ...
      return React.createElement(Labelled, {
        ...
        onBlur: this.handleBlur,
        onClick: this.handleClick
      }, prefixMarkup, input, suffixMarkup, spinnerMarkup, React.createElement("div", {
...
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(TextField$$1, _React$PureComponent);

  function TextField$$1() {
    _classCallCheck(this, TextField$$1);

    return _possibleConstructorReturn(this, _getPrototypeOf(TextField$$1).apply(this, arguments));
  }

  _createClass(TextField$$1, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      ...
      return React.createElement(TextField, Object.assign({}, this.props, {
        autoComplete: false,
...
TextField$1.contextTypes = contextTypes$1;

tslib_1.__decorate([decorators.autobind], TextField$1.prototype, "handleContextUpdate", null);
...
ComboBox.TextField = TextField$1;
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      }, React.createElement(ButtonGroup, null, buttonFrom(action, {
        outline: true,
...
function (_React$Component) {
  ...
  _createClass(Collapsible, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = styles.classNames(styles$D.Collapsible, open && styles$D.open, animating && styles$D.animating);
...
function (_React$Component) {
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      ...
      var className = reactUtilities.classNames(styles$F.Toast, error && styles$F.error);
      return React.createElement("div", {
        className: className
      }, React.createElement(KeypressListener, {
        keyCode: exports.Key.Escape,
  ...
  _createClass(ToastManager, [{
    ...
    value: function render() {
      ...
      return React.createElement(Portal, {
        ...
        className: styles$G.ToastManager
...
var toastClasses = {
  enter: styles.classNames(styles$G.ToastWrapper, styles$G['ToastWrapper-enter']),
  enterDone: styles.classNames(styles$G.ToastWrapper, styles$G['ToastWrapper-enter-done']),
  exit: styles.classNames(styles$G.ToastWrapper, styles$G['ToastWrapper-exit'])
};
...
function Dialog(_a) {
  ...
  var classes = styles.classNames(styles$I.Modal, large && styles$I.sizeLarge, limitHeight && styles$I.limitHeight);
...
var fadeUpClasses = {
  enter: styles.classNames(styles$I.animateFadeUp, styles$I.entering),
  enterActive: styles.classNames(styles$I.animateFadeUp, styles$I.entered),
  exit: styles.classNames(styles$I.animateFadeUp, styles$I.exiting),
  exitActive: styles.classNames(styles$I.animateFadeUp, styles$I.exited)
};
...
function Footer(_ref) {
  ...
  return React.createElement("div", {
    ...
    className: styles$J.FooterContent
...
function DisplayText(_ref) {
  ...
  var className = styles.classNames(styles$K.DisplayText, size && styles$K[styles.variationName('size', size)]);
  return React.createElement(Element, {
    className: className
  }, children);
}
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var className = reactUtilities.classNames(styles$L.CloseButton, !title && styles$L.withoutTitle);
  return React.createElement("button", {
    onClick: onClick,
    className: className
  }, React.createElement(Icon$1, {
...
function Section$3(_ref) {
  ...
  var className = styles.classNames(styles$N.Section, flush && styles$N.flush, subdued && styles$N.subdued);
    ...
    value: function render() {
      ...
      if (open) {
        ...
        dialog = React.createElement(Dialog, {
          ...
          className: styles$O.BodyWrapper
  ...
  _createClass(ContextualSaveBar, [{
    ...
    value: function render() {
      ...
      return React.createElement(React.Fragment, null, React.createElement("div", {
        ...
        className: styles$P.Contents
      }, React.createElement("h2", {
        className: styles$P.Message
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var navClassName = styles.classNames(styles$Q.Navigation, showMobileNavigation && styles$Q['Navigation-visible']);
      ...
      var navigationMarkup = navigation ? React.createElement(TrapFocus, {
        ...
        type: "button",
        className: styles$Q.NavigationDismiss,
      ...
      var topBarMarkup = topBar ? React.createElement("div", Object.assign({
        className: styles$Q.TopBar
      }, layer.props, dataPolarisTopBar.props, {
        id: APP_FRAME_TOP_BAR
      }), topBar) : null;
      var globalRibbonMarkup = globalRibbon ? React.createElement("div", {
        className: styles$Q.GlobalRibbonContainer,
        ref: this.setGlobalRibbonContainer
      }, globalRibbon) : null;
      var skipClassName = styles.classNames(styles$Q.Skip, skipFocused && styles$Q.focused);
      ...
      var frameClassName = styles.classNames(styles$Q.Frame, navigation && styles$Q.hasNav, topBar && styles$Q.hasTopBar);
      ...
      }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, navigationMarkup, React.createElement("main", {
        className: styles$Q.Main,
        id: APP_FRAME_MAIN,
...
var navTransitionClasses = {
  enter: styles.classNames(styles$Q['Navigation-enter']),
  enterActive: styles.classNames(styles$Q['Navigation-enterActive']),
  enterDone: styles.classNames(styles$Q['Navigation-enterActive']),
  exit: styles.classNames(styles$Q['Navigation-exit']),
  exitActive: styles.classNames(styles$Q['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
  enter: styles.classNames(styles$Q['ContextualSaveBar-enter']),
  enterActive: styles.classNames(styles$Q['ContextualSaveBar-enterActive']),
  enterDone: styles.classNames(styles$Q['ContextualSaveBar-enterActive']),
  exit: styles.classNames(styles$Q['ContextualSaveBar-exit']),
  exitActive: styles.classNames(styles$Q['ContextualSaveBar-exitActive'])
};
...
function Cell(_ref) {
  ...
  var className = styles.classNames(styles$R.Cell, fixed && styles$R['Cell-fixed'], fixed && truncate && styles$R['Cell-truncated'], header && styles$R['Cell-header'], total && styles$R['Cell-total'], footer && styles$R['Cell-footer'], numeric && styles$R['Cell-numeric'], sortable && styles$R['Cell-sortable'], sorted && styles$R['Cell-sorted']);
  var headerClassName = styles.classNames(header && styles$R.Heading, header && contentType === 'text' && styles$R['Heading-left']);
  var iconClassName = styles.classNames(sortable && styles$R.Icon);
  var style = {
...
function Navigation(_ref) {
  ...
  var pipMarkup = columnVisibilityData.map(function (column, index) {
    var className = styles.classNames(styles$R.Pip, column.isVisible && styles$R['Pip-visible']);
    return React.createElement("div", {
      className: className,
...
function (_React$PureComponent) {
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$R.DataTable, collapsed && styles$R.collapsed, footerContent && styles$R.hasFooter);
      var wrapperClassName = styles.classNames(styles$R.TableWrapper, collapsed && styles$R.collapsed);
      var footerClassName = styles.classNames(footerContent && styles$R.TableFoot);
      ...
      return React.createElement("div", {
        ...
        className: styles$R.ScrollContainer,
    ...
    value: function defaultRenderRow(row, index) {
      var className = styles.classNames(styles$R.TableRow);
      var _this$props4 = this.props,
...
function (_React$PureComponent) {
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$S.Day, selected && styles$S['Day-selected'], disabled && styles$S['Day-disabled'], today && styles$S['Day-today'], (inRange || inHoveringRange) && !disabled && styles$S['Day-inRange']);
...
function Weekday(_ref) {
  ...
  var className = styles.classNames(styles$S.Weekday, current && styles$S['Weekday-current']);
  return React.createElement("div", {
...
function Month(_ref) {
  ...
  var className = styles.classNames(styles$S.Title, current && styles$S['Month-current']);
  ...
  return React.createElement("div", {
    ...
    role: "rowheader",
    className: styles$S.WeekHeadings
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: styles$S.MonthContainer
...
function DescriptionList(_ref) {
  ...
  return React.createElement("dl", {
    className: styles$T.DescriptionList
  }, terms);
}
...
function (_React$Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var imageClasses = styles.classNames(styles$V.Image, size && size === 'extraLarge' && styles$V.sizeExtraLarge, size && size === 'large' && styles$V.sizeLarge);
...
var FileUpload$1 = compose$2(withContext(Consumer$1), withAppProvider(), withRef())(FileUpload);
...
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var classes = styles.classNames(styles$W.DropZone, outline && styles$W.hasOutline, (active || dragging) && styles$W.isDragging, error && styles$W.hasError, size && size === 'extraLarge' && styles$W.sizeExtraLarge, size && size === 'large' && styles$W.sizeLarge, size && size === 'medium' && styles$W.sizeMedium, size && size === 'small' && styles$W.sizeSmall);
      var dragOverlay = (active || dragging) && !error && overlay ? React.createElement("div", {
        className: styles$W.Overlay
      }, React.createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, React.createElement(Icon$1, {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          action = _this$props.action,
          secondaryAction = _this$props.secondaryAction;
      var className = styles.classNames(styles$Y.EmptyState, imageContained && styles$Y.imageContained);
      ...
      return React.createElement("div", {
        ...
        className: styles$Y.Section
      }, React.createElement("div", {
        className: styles$Y.DetailsContainer
      }, React.createElement("div", {
        ...
        className: styles$Y.ImageContainer
      }, imageMarkup)));
    }
  }]);
...
function ExceptionList(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = styles.classNames(styles$_.Item, status && styles$_[styles.variationName('status', status)]);
    var iconMarkup = icon ? React.createElement(Icon$1, {
      source: icon
    }) : React.createElement("span", {
      className: styles$_.Bullet
    });
  ...
  return React.createElement("ul", {
    className: styles$_.ExceptionList
  }, items);
}
...
function FooterHelp(_ref) {
  var children = _ref.children;
  return React.createElement("div", {
    className: styles$10.FooterHelp
  }, React.createElement("div", {
...
function Group(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title,
      helpText = _ref.helpText;
  var className = styles.classNames(condensed ? styles$11.condensed : styles$11.grouped);
...
function (_React$PureComponent) {
  ...
  _createClass(FormLayout, [{
    ...
    value: function render() {
      var children = this.props.children;
      return React.createElement("div", {
        className: styles$11.FormLayout
...
function KeyboardKey(_ref) {
  ...
  return React.createElement("kbd", {
    className: styles$12.KeyboardKey
  }, key);
}
...
function AnnotatedSection(props) {
  ...
  return React.createElement("div", {
    className: styles$13.AnnotatedSection
  }, React.createElement("div", {
    className: styles$13.AnnotationWrapper
  }, React.createElement("div", {
    className: styles$13.Annotation
  }, React.createElement(TextContainer, null, React.createElement(Heading, null, title), descriptionMarkup && React.createElement("div", {
    className: styles$13.AnnotationDescription
  }, descriptionMarkup))), React.createElement("div", {
    className: styles$13.AnnotationContent
  }, children)));
}
...
function Section$4(_ref) {
  ...
  var className = styles.classNames(styles$13.Section, secondary && styles$13['Section-secondary'], fullWidth && styles$13['Section-fullWidth'], oneHalf && styles$13['Section-oneHalf'], oneThird && styles$13['Section-oneThird']);
  return React.createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(ContentList, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$14.List, type && styles$14[styles.variationName('type', type)]);
...
function Indicator(_ref) {
  ...
  var className = styles.classNames(styles$15.Indicator, pulse && styles$15.pulseIndicator);
  return React.createElement("span", {
    className: className
  });
}
...
function (_React$Component) {
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      if (url == null) {
        var _className = styles.classNames(styles$16.Item, disabled && styles$16['Item-disabled']);

        return React.createElement("li", {
          className: styles$16.ListItem
      ...
      var secondaryActionMarkup = secondaryAction && React.createElement(UnstyledLink$1, {
        ...
        className: styles$16.SecondaryAction,
        tabIndex: tabIndex,
        "aria-disabled": disabled,
      ...
      var itemClassName = styles.classNames(styles$16.Item, disabled && styles$16['Item-disabled'], selected && subNavigationItems.length === 0 && styles$16['Item-selected'], showExpanded && styles$16.subNavigationActive);
      ...
      if (subNavigationItems.length > 0 && showExpanded) {
        ...
        secondaryNavigationMarkup = React.createElement("div", {
          className: styles$16.SecondaryNavigation
      ...
      var className = styles.classNames(styles$16.ListItem, secondaryAction && styles$16['ListItem-hasAction']);
      return React.createElement("li", {
        className: className
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var expanded = this.state.expanded;
      var className = styles.classNames(styles$16.Section, separator && styles$16['Section-withSeparator'], fill && styles$16['Section-fill']);
      var actionMarkup = action && React.createElement("button", {
        type: "button",
        className: styles$16.Action,
      ...
      var sectionHeadingMarkup = title && React.createElement("li", {
        className: styles$16.SectionHeading
      }, React.createElement("span", {
        className: styles$16.Text
      }, title), actionMarkup);
      ...
      var toggleClassName = styles.classNames(styles$16.Item, styles$16.RollupToggle);
      ...
      var activeItemsMarkup = rollup && additionalItems.length > 0 && React.createElement("li", {
        className: styles$16.RollupSection
...
var styles$17 = {
  "Message": "Polaris-Navigation-Message",
};
...
function Message(_ref) {
  ...
  return React.createElement("div", {
    ...
    url: link.to
  }, link.content), React.createElement(Button$1, {
    onClick: action.onClick,
    plain: true
  }, action.content)));
}
...
function MessageIndicator(_ref) {
  ...
  var indicatorMarkup = active && React.createElement("div", {
    className: styles$18.MessageIndicator
  });
  return React.createElement("div", {
    className: styles$18.MessageIndicatorWrapper
  }, indicatorMarkup, children);
}

var styles$19 = {
  "UserMenu": "Polaris-Navigation-UserMenu",
  "Section": "Polaris-Navigation-UserMenu__Section",
  "Button": "Polaris-Navigation-UserMenu__Button",
  "Avatar": "Polaris-Navigation-UserMenu__Avatar",
  "Details": "Polaris-Navigation-UserMenu__Details",
  "Name": "Polaris-Navigation-UserMenu__Name",
  "Detail": "Polaris-Navigation-UserMenu__Detail",
  "List": "Polaris-Navigation-UserMenu__List",
  "expanded": "Polaris-Navigation-UserMenu--expanded",
  "Icon": "Polaris-Navigation-UserMenu__Icon",
  "Item": "Polaris-Navigation-UserMenu__Item",
  "DisclosureIcon": "Polaris-Navigation-UserMenu__DisclosureIcon",
  "fade-in": "Polaris-Navigation-UserMenu__fade--in",
};

var UserMenu =
/*#__PURE__*/
function (_React$PureComponent) {
  _inherits(UserMenu, _React$PureComponent);
  ...
  function UserMenu() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(UserMenu).apply(this, arguments));
    _this.state = {
  ...
  _createClass(UserMenu, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          actions$$1 = _this$props.actions,
          message = _this$props.message;
      var userMenuExpanded = this.state.userMenuExpanded;
      var className = styles.classNames(styles$19.UserMenu, userMenuExpanded && styles$19.expanded);
      var itemClassName = styles$19.Item;
      var tabIndex = userMenuExpanded ? 0 : -1;
      var itemsMarkup = actions$$1 && actions$$1.map(function (section) {
        return React.createElement("div", {
          className: styles$19.Section,
          key: section.id
        }, section.items.map(function (item) {
          var icon = item.icon;
          return item.url ? React.createElement(UnstyledLink$1, {
            url: item.url,
            key: item.content,
            className: itemClassName,
            tabIndex: tabIndex,
            ...
            type: "button",
            key: item.content,
            onClick: item.onAction ? _this2.createActionHandler(item.onAction) : _this2.handleClick,
            className: itemClassName,
            tabIndex: tabIndex
      ...
      var messageMarkup = message && React.createElement("div", {
        className: styles$19.Section
      ...
      return React.createElement("div", {
        ...
        type: "button",
        className: styles$19.Button,
        onClick: this.handleClick,
        onMouseUp: handleMouseUp$1
      }, React.createElement("span", {
        className: styles$19.Avatar
        ...
        className: styles$19.Details
      }, React.createElement("span", {
        className: styles$19.Name
      }, name), React.createElement("span", {
        className: styles$19.Detail
      }, detail)), React.createElement("span", {
        className: styles$19.DisclosureIcon
      }, React.createElement(Icon$1, {
        source: "chevronDown",
        color: "inkLightest",
        accessibilityLabel: "Show user menu"
      }))), React.createElement("div", {
        className: styles$19.List,
        "aria-hidden": !userMenuExpanded
      }, itemsMarkup, messageMarkup));
    }
  }, {
    key: "createActionHandler",
    value: function createActionHandler(handler) {
      var _this3 = this;
    ...
    value: function handleClick() {
      this.setState(function (_ref) {
        var userMenuExpanded = _ref.userMenuExpanded;
        return {
...
tslib_1.__decorate([decorators.memoize()], UserMenu.prototype, "createActionHandler", null);

tslib_1.__decorate([decorators.autobind], UserMenu.prototype, "handleClick", null);

function handleMouseUp$1(_ref2) {
  var currentTarget = _ref2.currentTarget;
  currentTarget.blur();
}
...
function (_React$Component) {
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      return React.createElement("nav", {
        className: styles$16.Navigation
      }, React.createElement("div", {
        className: styles$16.UserMenu
      }, userMenu), React.createElement(Scrollable$1, {
        className: styles$16.PrimaryNavigation
      }, children));
    }
  }]);
...
Navigation$2.UserMenu = UserMenu;
...
function (_React$PureComponent) {
  ...
  _createClass(TooltipOverlay, [{
    ...
    value: function renderTooltip(overlayDetails) {
      ...
      var containerClassName = styles.classNames(styles$1a.Tooltip, light && styles$1a.light, measuring && styles$1a.measuring, positioning === 'above' && styles$1a.positionedAbove);
      var contentStyles = measuring ? undefined : {
...
function Pagination(_ref) {
  ...
  var className = reactUtilities.classNames(styles$1b.Pagination, plain && styles$1b.plain);
...
function Action(_ref) {
  ...
  var iconMarkup = icon && React.createElement("span", {
    className: styles$1c.ActionIcon
  }, React.createElement(Icon$1, {
    source: icon
  }));
  ...
  var contentMarkup = iconMarkup || disclosureIconMarkup ? React.createElement("span", {
    className: styles$1c.ActionContent
  ...
  var className = reactUtilities.classNames(styles$1c.Action, disabled && styles$1c.disabled, icon && children == null && styles$1c.iconOnly);
  return React.createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
  ...
  _createClass(ActionGroup, [{
    ...
    value: function render() {
      ...
      var detailsMarkup = details && React.createElement("div", {
        className: styles$1d.Details
      }, details);
      return React.createElement("div", {
        className: styles$1d.ActionGroup,
...
function (_React$PureComponent) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$1e.Header, titleHidden && styles$1e['Title-hidden'], pagination && styles$1e['Header-hasPagination'], separator && styles$1e['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$1e['Header-hasBreadcrumbs'], this.hasRollup && styles$1e['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$1e['Header-hasSecondaryActions']);
      ...
      var primaryActionMarkup = primaryAction ? React.createElement("div", {
        className: styles$1e.PrimaryAction
      ...
      return primaryActionMarkup ? React.createElement("div", {
        ...
        className: styles$1e.MainContent
      }, React.createElement("div", {
        className: styles$1e.TitleAndActions
    ...
    value: function renderSecondaryActions() {
      ...
      var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref, index) {
        var title = _ref.title,
            ...
            details = _ref.details;
        return React.createElement("div", {
          className: styles$1e.IndividualAction,
      ...
      return React.createElement("div", {
        className: styles$1e.SecondaryActions
      }, React.createElement("div", {
        className: styles$1e.IndividualActions
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$1f.Page, fullWidth && styles$1f.fullWidth, singleColumn && styles$1f.singleColumn);
      var headerMarkup = this.props.polaris.appBridge || this.hasHeaderContent() === false ? null : React.createElement(Header$3, rest);
      return React.createElement("div", {
        className: className
      }, headerMarkup, React.createElement("div", {
...
function PageActions(_ref) {
  ...
  return React.createElement("div", {
    className: styles$1g.PageActions
  }, React.createElement(Stack, {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var outputMarkup = !disabled && output && React.createElement("output", {
        htmlFor: id,
        className: styles$1h.Output
      }, React.createElement("div", {
        className: styles$1h.OutputBubble
      }, React.createElement("span", {
        className: styles$1h.OutputText
      }, value)));
      var prefixMarkup = prefix && React.createElement("div", {
        className: styles$1h.Prefix
      }, prefix);
      var suffixMarkup = suffix && React.createElement("div", {
        className: styles$1h.Suffix
      }, suffix);
      var className = styles.classNames(styles$1h.RangeSlider, error && styles$1h.error, disabled && styles$1h.disabled);
      return React.createElement(Labelled, {
        id: id,
        label: label,
        error: error,
        ...
        className: styles$1h.InputWrapper
      }, React.createElement("input", {
        type: "range",
...
function Select(_ref) {
  ...
  var className = styles.classNames(styles$1i.Select, error && styles$1i.error, disabled && styles$1i.disabled);
  ...
  var inlineLabelMarkup = labelInline && React.createElement("span", {
    className: styles$1i.InlineLabel
  }, label);
  ...
  var contentMarkup = React.createElement("div", {
    ...
    className: styles$1i.SelectedOption
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? styles.classNames(styles$1j.CheckableButton, styles$1j['CheckableButton-plain']) : styles.classNames(styles$1j.CheckableButton, selectMode && styles$1j['CheckableButton-selectMode'], selected && styles$1j['CheckableButton-selected'], measuring && styles$1j['CheckableButton-measuring']);
  return React.createElement("div", {
    className: className,
    onClick: onToggleAll
  }, React.createElement("div", {
    className: styles$1j.Checkbox
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          disabled = _this$props.disabled;
      var disclosureIconMarkup = disclosure ? React.createElement("span", {
        className: styles$1k.ActionIcon
      }, React.createElement(Icon$1, {
        source: "caretDown"
      })) : null;
      var contentMarkup = disclosureIconMarkup ? React.createElement("span", {
        className: styles$1k.ActionContent
      ...
      var className = reactUtilities.classNames(styles$1k.Button, disabled && styles$1k.disabled);
      return React.createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: styles.classNames(styles$1k.Slide, styles$1k['Slide-appear']),
  appearActive: styles.classNames(styles$1k.Slide, styles$1k['Slide-appearing']),
  enter: styles.classNames(styles$1k.Slide, styles$1k['Slide-enter']),
  enterActive: styles.classNames(styles$1k.Slide, styles$1k['Slide-entering']),
  exit: styles.classNames(styles$1k.Slide, styles$1k['Slide-exit'])
};
var BulkActions =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? React.createElement("div", {
        className: styles$1k.PaginatedSelectAll
      }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
      var cancelButtonClassName = styles.classNames(styles$1k.Button, styles$1k['Button-cancel']);
      ...
      var smallScreenGroup = React.createElement(reactTransitionGroup.Transition, {
        ...
        var smallScreenGroupClassName = styles.classNames(styles$1k.Group, styles$1k['Group-smallScreen'], styles$1k["Group-".concat(status)]);
        return React.createElement("div", {
          className: smallScreenGroupClassName
        }, React.createElement("div", {
          className: styles$1k.ButtonGroup
        }, React.createElement(reactTransitionGroup.CSSTransition, {
          in: selectMode,
          timeout: Duration.Base,
      ...
      var largeScreenGroup = React.createElement(reactTransitionGroup.Transition, {
        ...
        var largeScreenGroupClassName = styles.classNames(styles$1k.Group, styles$1k['Group-largeScreen'], !measuring && styles$1k["Group-".concat(status)], measuring && styles$1k['Group-measuring']);
        return React.createElement("div", {
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = reactUtilities.classNames(disabled && styles$1l.disabled, styles$1l.Tag);
  ...
  _createClass(DateSelector, [{
    ...
    value: function render() {
      ...
      var datePredicateMarkup = showDatePredicate && React.createElement(React.Fragment, null, React.createElement("div", {
        className: styles$1m.DateTextField
    ...
    value: function render() {
      ...
      switch (filter.type) {
        ...
        case exports.FilterType.TextField:
          return React.createElement(Stack, {
            vertical: true
          }, operatorOptionsMarkup, React.createElement(TextField, {
            label: selectedFilterLabel,
            value: value,
  ...
  _createClass(FilterControl, [{
    ...
    value: function render() {
      ...
      var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
        ...
        return React.createElement("li", {
          className: styles$1n.AppliedFilter,
          key: filterId
      ...
      var appliedFiltersWrapper = appliedFilters.length > 0 ? React.createElement("ul", {
        className: styles$1n.AppliedFilters
      }, appliedFiltersMarkup) : null;
      return React.createElement(FormLayout, null, React.createElement(TextField, {
...
var FilterControl$1 = compose(withAppProvider(), withContext(Consumer$2))(FilterControl);
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$1o.Item, focused && styles$1o.focused, selectable && styles$1o.selectable, selected && styles$1o.selected, selectMode && styles$1o.selectMode, persistActions && styles$1o.persistActions, focusedInner && styles$1o.focusedInner);
...
var Item$8 = compose(withContext(Consumer$2), withAppProvider())(Item$7);
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var filterControlMarkup = filterControl ? React.createElement("div", {
        className: styles$1p.FiltersWrapper
      }, filterControl) : null;
      var bulkActionsMarkup = this.selectable ? React.createElement("div", {
        className: styles$1p.BulkActionsWrapper
      ...
      var sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? React.createElement("div", {
        className: styles$1p.SortWrapper
      ...
      var alternateToolMarkup = alternateTool && !sortingSelectMarkup ? React.createElement("div", {
        className: styles$1p.AlternateToolWrapper
      }, alternateTool) : null;
      var headerTitleMarkup = React.createElement("div", {
        className: styles$1p.HeaderTitleWrapper
      }, this.headerTitle);
      var selectButtonMarkup = this.selectable ? React.createElement("div", {
        className: styles$1p.SelectButtonWrapper
      }, React.createElement(Button$1, {
        disabled: selectMode,
      ...
      var checkableButtonMarkup = this.selectable ? React.createElement("div", {
        className: styles$1p.CheckableButtonWrapper
      ...
      var headerWrapperOverlay = loading ? React.createElement("div", {
        className: styles$1p['HeaderWrapper-overlay']
      }) : null;
      var headerMarkup = (showHeader || needsHeader) && this.listRef.current && React.createElement("div", {
        className: styles$1p.HeaderOuterWrapper
      }, React.createElement(Sticky, {
        boundingElement: this.listRef.current
      }, function (isSticky) {
        var headerClassName = styles.classNames(styles$1p.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles$1p['HeaderWrapper-hasSort'], alternateTool && styles$1p['HeaderWrapper-hasAlternateTool'], _this2.selectable && styles$1p['HeaderWrapper-hasSelect'], loading && styles$1p['HeaderWrapper-disabled'], _this2.selectable && selectMode && styles$1p['HeaderWrapper-inSelectMode'], isSticky && styles$1p['HeaderWrapper-isSticky']);
        return React.createElement("div", {
          className: headerClassName
        }, headerWrapperOverlay, React.createElement("div", {
          className: styles$1p.HeaderContentWrapper
      ...
      var emptyStateMarkup = filterControl && !this.itemsExist() && !loading ? React.createElement("div", {
        className: styles$1p.EmptySearchResultWrapper
      ...
      var loadingOverlay = loading ? React.createElement(React.Fragment, null, React.createElement("div", {
        className: styles$1p.SpinnerContainer,
        style: spinnerStyle
      }, React.createElement(Spinner$1, {
        size: spinnerSize,
        accessibilityLabel: "Items are loading"
      })), React.createElement("div", {
        className: styles$1p.LoadingOverlay
      })) : null;
      var className = styles.classNames(styles$1p.ItemWrapper, loading && styles$1p['ItemWrapper-isLoading']);
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? React.createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = styles.classNames(styles$1p.ResourceList, loading && styles$1p.disabledPointerEvents);
      ...
      return React.createElement(Provider$2, {
        ...
        className: styles$1p.ResourceListWrapper
    ...
    value: function renderItem(item, index) {
      ...
      return React.createElement("li", {
        key: id,
        className: styles$1p.ItemWrapper
      }, renderItem(item, id));
    }
  }, {
  ...
  _createClass(ResourcePicker, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$props = this.props,
          ...
          showHidden = _this$props$showHidde === void 0 ? false : _this$props$showHidde,
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$1q.Tab, selected && styles$1q['Tab-selected']);
      var tabIndex;
      ...
      return React.createElement("li", {
        role: "presentation",
        className: styles$1q.TabContainer,
        ref: this.setNode
      }, markup);
    }
  }, {
...
function (_React$PureComponent) {
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = styles.classNames(styles$1q.Tabs, styles$1q.TabMeasurer);
      return React.createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, React.createElement(EventListener, {
...
function (_React$PureComponent) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var classname = styles.classNames(styles$1q.Tabs, fitted && styles$1q.fitted, disclosureActivatorVisible && styles$1q.fillSpace);
      var disclosureTabClassName = styles.classNames(styles$1q.DisclosureTab, disclosureActivatorVisible && styles$1q['DisclosureTab-visible']);
      var activator = React.createElement("button", {
        tabIndex: -1,
        className: styles$1q.DisclosureActivator,
    ...
    value: function handleFocus(event) {
      ...
      if (target$$1.classList.contains(styles$1q.Tab) || target$$1.classList.contains(styles$1q.Item)) {
        var tabToFocus = -1;
      ...
      if (target$$1.classList.contains(styles$1q.DisclosureActivator)) {
        return;
      ...
      if (!relatedTarget.classList.contains(styles$1q.Tab) && !relatedTarget.classList.contains(styles$1q.Item) && !relatedTarget.classList.contains(styles$1q.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = styles.classNames(styles$1r.Thumbnail, size && styles$1r[styles.variationName('size', size)]);
  return React.createElement("span", {
    className: className
  }, React.createElement(Image, {
    alt: alt,
    source: source,
    className: styles$1r.Image
  }));
}
  ...
  _createClass(Toast, [{
    ...
    value: function componentDidMount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeToast = actions.Flash.create(appBridge, {
          message: content,
          duration: duration,
          isError: error,
          isDismissible: true
        });
        this.appBridgeToast.subscribe(actions.Flash.Action.CLEAR, onDismiss);
        this.appBridgeToast.dispatch(actions.Flash.Action.SHOW);
      }
    }
  }, {
    key: "componentWillUnmount",
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          children = _this$props.children;
      var searchClassName = styles.classNames(styles$1s.Search, visible && styles$1s.visible);
      return React.createElement("div", {
        ref: this.node,
        className: searchClassName,
        onClick: this.handleDismiss
      }, React.createElement("div", {
        className: styles$1s.Overlay
      }, children));
    }
  }, {
    key: "handleDismiss",
  ...
  _createClass(SearchField, [{
    ...
    value: function render() {
      ...
      var clearMarkup = value !== '' && React.createElement("button", {
        type: "button",
        "aria-label": "Clear",
        className: styles$1t.Clear,
        onClick: this.handleClear
      }, React.createElement(Icon$1, {
        source: "circleCancel"
      }));
      var className = styles.classNames(styles$1t.SearchField, (focused || active) && styles$1t.focused);
      return React.createElement("div", {
        className: className,
        onFocus: this.handleFocus,
        onBlur: this.handleBlur
...
function Menu(props) {
  ...
  var messageMarkup = message && React.createElement(Message$1, {
    title: message.title,
    description: message.description,
    action: {
      onClick: message.action.onClick,
...
function UserMenu$1(_ref) {
  ...
  var activatorContentMarkup = React.createElement("div", {
    ...
    className: styles$1w.Details
  }, React.createElement("p", {
    className: styles$1w.Name,
    title: "altText"
  }, name), React.createElement("p", {
    className: styles$1w.Detail
  }, detail)));
  ...
  _createClass(TopBar, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          logo = _this$props.polaris.theme.logo;
      var focused = this.state.focused;
      var className = styles.classNames(styles$1x.NavigationIcon, focused && styles$1x.focused);
      ...
      var width = getWidth(logo, 104);
      var logoMarkup = logo ? React.createElement(UnstyledLink$1, {
        url: logo.url || '',
        className: styles$1x.LogoLink,
        style: {
          width: width
        }
      }, React.createElement(Image, {
      ...
      return React.createElement("div", {
        className: styles$1x.TopBar
      }, navigationButtonMarkup, React.createElement("div", {
        className: styles$1x.LogoContainer
      }, logoMarkup), React.createElement("div", {
        className: styles$1x.Contents
      }, searchMarkup, secondaryMenu, userMenu));
    }
  }, {
    key: "handleFocus",
    value: function handleFocus() {
...
function SkeletonDisplayText(_ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = styles.classNames(styles$1y.DisplayText, size && styles$1y[styles.variationName('size', size)]);
  return React.createElement("div", {
    className: className
  });
}
...
function SkeletonBodyText(_ref) {
  ...
  for (var i = 0; i < lines; i++) {
    bodyTextLines.push(React.createElement("div", {
      className: styles$1z.SkeletonBodyText,
      key: i
    }));
  }

  return React.createElement("div", {
    className: styles$1z.SkeletonBodyTextContainer
  }, bodyTextLines);
}
  ...
  _createClass(SkeletonPage, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          breadcrumbs = _this$props.breadcrumbs;
      var className = styles.classNames(styles$1A.Page, fullWidth && styles$1A.fullWidth, singleColumn && styles$1A.singleColumn);
      var headerClassName = styles.classNames(styles$1A.Header, breadcrumbs && styles$1A['Header-hasBreadcrumbs'], secondaryActions && styles$1A['Header-hasSecondaryActions']);
      var titleMarkup = title !== null ? renderTitle(title) : null;
      var primaryActionMarkup = primaryAction ? React.createElement("div", {
        className: styles$1A.PrimaryAction
      ...
      var breadcrumbMarkup = breadcrumbs ? React.createElement("div", {
        className: styles$1A.BreadcrumbAction,
        style: {
          width: 60
        }
      ...
      var headerMarkup = !this.props.polaris.appBridge ? React.createElement("div", {
        ...
        className: styles$1A.TitleAndPrimaryAction

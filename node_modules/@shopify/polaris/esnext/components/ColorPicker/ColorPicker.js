...
export default class ColorPicker extends React.PureComponent {
    ...
    render() {
        ...
        return (<div className={styles.ColorPicker} id={id}>
...
tslib_1.__decorate([
    autobind
], ColorPicker.prototype, "setColorNode", null);
tslib_1.__decorate([
    autobind
], ColorPicker.prototype, "handleHueChange", null);
tslib_1.__decorate([
    autobind
], ColorPicker.prototype, "handleAlphaChange", null);
tslib_1.__decorate([
    autobind
], ColorPicker.prototype, "handleDraggerMove", null);

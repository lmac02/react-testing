...
export class BulkActions extends React.PureComponent {
    ...
    render() {
        ...
        onClick={this.setSelectMode.bind(this, false)} testID="btn-cancel">
        Cancel
      </button>);
        ...
        <Popover active={smallScreenPopoverVisible} activator={<BulkActionButton disclosure onAction={this.toggleSmallScreenPopover} content={intl.translate('Polaris.ResourceList.BulkActions.actionsActivatorLabel')}/>} onClose={this.toggleSmallScreenPopover}>
        ...
        const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0
            ? [...promotedActions]
                ...
                .map((action, index) => (<BulkActionButton {...action} key={index} handleMeasurement={this.handleMeasurement}/>))
            : null;
...
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "setLargeScreenButtonsNode", null);
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "setContainerNode", null);
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "setMoreActionsNode", null);
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "setSelectMode", null);
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "toggleSmallScreenPopover", null);
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "toggleLargeScreenPopover", null);
tslib_1.__decorate([
    autobind,
...
tslib_1.__decorate([
    autobind
], BulkActions.prototype, "handleMeasurement", null);

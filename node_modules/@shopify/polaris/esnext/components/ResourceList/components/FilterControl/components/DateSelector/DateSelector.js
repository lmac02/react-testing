...
class DateSelector extends React.PureComponent {
    ...
    render() {
        ...
        <div className={styles.DateTextField}>
          <TextField label={intl.translate('Polaris.ResourceList.DateSelector.dateValueLabel')} placeholder={intl.translate('Polaris.ResourceList.DateSelector.dateValuePlaceholder')} value={this.dateTextFieldValue} error={userInputDateError} prefix={<Icon source="calendar" color="skyDark"/>} autoComplete={false} onChange={this.handleDateFieldChange} onBlur={this.handleDateBlur}/>
        </div>
...
tslib_1.__decorate([
    autobind
], DateSelector.prototype, "handleDateFilterOptionsChange", null);
tslib_1.__decorate([
    autobind
], DateSelector.prototype, "handleDateFieldChange", null);
tslib_1.__decorate([
    autobind
], DateSelector.prototype, "handleDateBlur", null);
tslib_1.__decorate([
    autobind
], DateSelector.prototype, "handleDatePickerChange", null);
tslib_1.__decorate([
    autobind
], DateSelector.prototype, "handleDatePickerMonthChange", null);

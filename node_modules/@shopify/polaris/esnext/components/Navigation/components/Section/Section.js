...
export default class Section extends React.Component {
    ...
    render() {
        ...
        const itemsMarkup = items.map((item) => {
            const { onClick, label } = item, rest = tslib_1.__rest(item, ["onClick", "label"]);
            return (<Item {...rest} key={label} label={label} onClick={this.handleClick(onClick)}/>);
        });
...
tslib_1.__decorate([
    memoize()
], Section.prototype, "handleClick", null);
tslib_1.__decorate([
    autobind
], Section.prototype, "toggleViewAll", null);

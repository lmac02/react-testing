...
export class SkeletonPage extends React.PureComponent {
    render() {
        const { children, fullWidth, singleColumn, primaryAction, secondaryActions, title = '', breadcrumbs, } = this.props;
        ...
        return (<div className={className} role="status" aria-label="Page loading">
        {headerMarkup}

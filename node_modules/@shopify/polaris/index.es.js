...
import { Redirect, ButtonGroup, Button, Modal, Loading, TitleBar, ResourcePicker, Flash } from '@shopify/app-bridge/actions';
...
function Button$1(_ref) {
  ...
  var className = classNames$1(styles$3.Button, primary && styles$3.primary, outline && styles$3.outline, destructive && styles$3.destructive, isDisabled && styles$3.disabled, loading && styles$3.loading, plain && styles$3.plain, size && size !== DEFAULT_SIZE && styles$3[variationName$1('size', size)], fullWidth && styles$3.fullWidth, icon && children == null && styles$3.iconOnly);
  ...
  var childMarkup = children ? createElement("span", null, children) : null;
...
function Section(_ref) {
  var children = _ref.children,
      ...
      fullWidth = _ref.fullWidth;
  var headerContent = title ? createElement("div", {
    className: styles$7.SectionHeader
  }, createElement(Subheading, null, title)) : null;
...
function Section$1(_ref) {
  ...
  var className = section.title ? null : styles$f['Section-withoutTitle'];
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      var _a = this.props,
          ...
          active = _a.active,
          fixed = _a.fixed,
          rest = __rest(_a, ["activatorWrapper", "children", "onClose", "activator", "activatorWrapper", "active", "fixed"]);
...
function (_React$PureComponent) {
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$p.TextField, Boolean(value) && styles$p.hasValue, disabled && styles$p.disabled, readOnly && styles$p.readOnly, error && styles$p.error, multiline && styles$p.multiline, this.state.focus && styles$p.focus);
      ...
      return createElement(Labelled, {
        ...
        onBlur: this.handleBlur,
        onClick: this.handleClick
      }, prefixMarkup, input, suffixMarkup, spinnerMarkup, createElement("div", {
...
function (_React$PureComponent) {
  ...
  _createClass(TextField$$1, [{
    ...
    value: function render() {
      ...
      return createElement(TextField, Object.assign({}, this.props, {
        autoComplete: false,
...
__decorate([autobind], TextField$1.prototype, "handleContextUpdate", null);
...
function (_React$PureComponent) {
  ...
  _createClass(Banner, [{
    ...
    value: function render() {
      ...
      }, createElement(ButtonGroup$1, null, buttonFrom(action, {
        outline: true,
...
function (_React$Component) {
  ...
  _createClass(Collapsible, [{
    ...
    value: function render() {
      ...
      var wrapperClassName = classNames(styles$C.Collapsible, open && styles$C.open, animating && styles$C.animating);
...
function (_React$Component) {
  ...
  _createClass(Toast, [{
    ...
    value: function render() {
      ...
      var className = classNames$1(styles$E.Toast, error && styles$E.error);
      return createElement("div", {
        className: className
      }, createElement(KeypressListener, {
        keyCode: Key.Escape,
  ...
  _createClass(ToastManager, [{
    ...
    value: function render() {
      ...
      return createElement(Portal, {
        ...
        className: styles$F.ToastManager
...
var toastClasses = {
  enter: classNames(styles$F.ToastWrapper, styles$F['ToastWrapper-enter']),
  enterDone: classNames(styles$F.ToastWrapper, styles$F['ToastWrapper-enter-done']),
  exit: classNames(styles$F.ToastWrapper, styles$F['ToastWrapper-exit'])
};
...
function (_React$Component) {
  ...
  _createClass(Loading$$1, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        className: styles$G.Loading
      }, createElement("div", {
        className: styles$G.Level,
        style: customStyles,
...
function Dialog(_a) {
  ...
  var classes = classNames(styles$H.Modal, large && styles$H.sizeLarge, limitHeight && styles$H.limitHeight);
...
var fadeUpClasses = {
  enter: classNames(styles$H.animateFadeUp, styles$H.entering),
  enterActive: classNames(styles$H.animateFadeUp, styles$H.entered),
  exit: classNames(styles$H.animateFadeUp, styles$H.exiting),
  exitActive: classNames(styles$H.animateFadeUp, styles$H.exited)
};
...
function Footer(_ref) {
  ...
  return createElement("div", {
    ...
    className: styles$I.FooterContent
  }, createElement(Stack, {
    alignment: "center"
  }, createElement(Stack.Item, {
    fill: true
...
function DisplayText(_ref) {
  ...
  var className = classNames(styles$J.DisplayText, size && styles$J[variationName('size', size)]);
  return createElement(Element, {
    className: className
  }, children);
}
...
function CloseButton(_ref) {
  var _ref$title = _ref.title,
      ...
      onClick = _ref.onClick;
  var className = classNames$1(styles$K.CloseButton, !title && styles$K.withoutTitle);
  return createElement("button", {
    onClick: onClick,
    className: className
  }, createElement(Icon$1, {
...
function Section$3(_ref) {
  ...
  var className = classNames(styles$M.Section, flush && styles$M.flush, subdued && styles$M.subdued);
    ...
    value: function render() {
      ...
      if (open) {
        ...
        dialog = createElement(Dialog, {
          ...
          className: styles$N.BodyWrapper
  ...
  _createClass(ContextualSaveBar, [{
    ...
    value: function render() {
      ...
      return createElement(Fragment, null, createElement("div", {
        className: styles$O.ContextualSaveBar
      }, logoMarkup, createElement("div", {
        className: styles$O.Contents
      }, createElement("h2", {
        className: styles$O.Message
  ...
  _createClass(Frame, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          intl = _this$props.polaris.intl;
      var navClassName = classNames(styles$P.Navigation, showMobileNavigation && styles$P['Navigation-visible']);
      ...
      var navigationMarkup = navigation ? createElement(TrapFocus, {
        ...
        type: "button",
        className: styles$P.NavigationDismiss,
      ...
      var topBarMarkup = topBar ? createElement("div", Object.assign({
        className: styles$P.TopBar
      }, layer.props, dataPolarisTopBar.props, {
        id: APP_FRAME_TOP_BAR
      }), topBar) : null;
      var globalRibbonMarkup = globalRibbon ? createElement("div", {
        className: styles$P.GlobalRibbonContainer,
        ref: this.setGlobalRibbonContainer
      }, globalRibbon) : null;
      var skipClassName = classNames(styles$P.Skip, skipFocused && styles$P.focused);
      ...
      var frameClassName = classNames(styles$P.Frame, navigation && styles$P.hasNav, topBar && styles$P.hasTopBar);
      ...
      }, layer.props, navigationAttributes), skipMarkup, topBarMarkup, contextualSaveBarMarkup, loadingMarkup, navigationOverlayMarkup, navigationMarkup, createElement("main", {
        className: styles$P.Main,
        id: APP_FRAME_MAIN,
...
var navTransitionClasses = {
  enter: classNames(styles$P['Navigation-enter']),
  enterActive: classNames(styles$P['Navigation-enterActive']),
  enterDone: classNames(styles$P['Navigation-enterActive']),
  exit: classNames(styles$P['Navigation-exit']),
  exitActive: classNames(styles$P['Navigation-exitActive'])
};
var contextualSaveBarTransitionClasses = {
  enter: classNames(styles$P['ContextualSaveBar-enter']),
  enterActive: classNames(styles$P['ContextualSaveBar-enterActive']),
  enterDone: classNames(styles$P['ContextualSaveBar-enterActive']),
  exit: classNames(styles$P['ContextualSaveBar-exit']),
  exitActive: classNames(styles$P['ContextualSaveBar-exitActive'])
};
...
function Cell(_ref) {
  ...
  var className = classNames(styles$Q.Cell, fixed && styles$Q['Cell-fixed'], fixed && truncate && styles$Q['Cell-truncated'], header && styles$Q['Cell-header'], total && styles$Q['Cell-total'], footer && styles$Q['Cell-footer'], numeric && styles$Q['Cell-numeric'], sortable && styles$Q['Cell-sortable'], sorted && styles$Q['Cell-sorted']);
  var headerClassName = classNames(header && styles$Q.Heading, header && contentType === 'text' && styles$Q['Heading-left']);
  var iconClassName = classNames(sortable && styles$Q.Icon);
  var style = {
...
function Navigation(_ref) {
  ...
  var pipMarkup = columnVisibilityData.map(function (column, index) {
    var className = classNames(styles$Q.Pip, column.isVisible && styles$Q['Pip-visible']);
    return createElement("div", {
      className: className,
...
function (_React$PureComponent) {
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$Q.DataTable, collapsed && styles$Q.collapsed, footerContent && styles$Q.hasFooter);
      var wrapperClassName = classNames(styles$Q.TableWrapper, collapsed && styles$Q.collapsed);
      var footerClassName = classNames(footerContent && styles$Q.TableFoot);
      ...
      return createElement("div", {
        ...
        className: styles$Q.ScrollContainer,
    ...
    value: function defaultRenderRow(row, index) {
      var className = classNames(styles$Q.TableRow);
      var _this$props4 = this.props,
...
function (_React$PureComponent) {
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$R.Day, selected && styles$R['Day-selected'], disabled && styles$R['Day-disabled'], today && styles$R['Day-today'], (inRange || inHoveringRange) && !disabled && styles$R['Day-inRange']);
...
function Weekday(_ref) {
  ...
  var className = classNames(styles$R.Weekday, current && styles$R['Weekday-current']);
  return createElement("div", {
...
function Month(_ref) {
  ...
  var className = classNames(styles$R.Title, current && styles$R['Month-current']);
  ...
  var weeksMarkup = weeks.map(function (week, index) {
    return createElement("div", {
      role: "row",
      className: styles$R.Week,
      key: index
    }, week.map(renderWeek));
  });
  return createElement("div", {
    role: "grid",
    className: styles$R.Month
  }, createElement("div", {
    className: className
  }, Months[month], " ", year), createElement("div", {
    role: "rowheader",
    className: styles$R.WeekHeadings
...
function DescriptionList(_ref) {
  ...
  return createElement("dl", {
    className: styles$S.DescriptionList
  }, terms);
}
...
function (_React$Component) {
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      ...
      var imageClasses = classNames(styles$U.Image, size && size === 'extraLarge' && styles$U.sizeExtraLarge, size && size === 'large' && styles$U.sizeLarge);
...
function (_React$Component) {
  ...
  _createClass(DropZone, [{
    ...
    value: function render() {
      ...
      var classes = classNames(styles$V.DropZone, outline && styles$V.hasOutline, (active || dragging) && styles$V.isDragging, error && styles$V.hasError, size && size === 'extraLarge' && styles$V.sizeExtraLarge, size && size === 'large' && styles$V.sizeLarge, size && size === 'medium' && styles$V.sizeMedium, size && size === 'small' && styles$V.sizeSmall);
      var dragOverlay = (active || dragging) && !error && overlay ? createElement("div", {
        className: styles$V.Overlay
      }, createElement(Stack, {
        vertical: true,
        spacing: "tight"
      }, createElement(Icon$1, {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          action = _this$props.action,
          secondaryAction = _this$props.secondaryAction;
      var className = classNames(styles$X.EmptyState, imageContained && styles$X.imageContained);
      ...
      return createElement("div", {
        ...
        className: styles$X.Section
      }, createElement("div", {
        className: styles$X.DetailsContainer
      }, createElement("div", {
        className: styles$X.Details
        ...
        className: styles$X.ImageContainer
      }, imageMarkup)));
    }
  }]);
...
function ExceptionList(_ref) {
  ...
  return createElement("ul", {
    className: styles$Z.ExceptionList
  }, items);
}
...
function Group(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title,
      helpText = _ref.helpText;
  var className = classNames(condensed ? styles$10.condensed : styles$10.grouped);
...
function (_React$PureComponent) {
  ...
  _createClass(FormLayout, [{
    ...
    value: function render() {
      var children = this.props.children;
      return createElement("div", {
        className: styles$10.FormLayout
...
function KeyboardKey(_ref) {
  ...
  return createElement("kbd", {
    className: styles$11.KeyboardKey
  }, key);
}
...
function AnnotatedSection(props) {
  ...
  return createElement("div", {
    className: styles$12.AnnotatedSection
  }, createElement("div", {
    className: styles$12.AnnotationWrapper
  }, createElement("div", {
    className: styles$12.Annotation
  }, createElement(TextContainer, null, createElement(Heading, null, title), descriptionMarkup && createElement("div", {
    className: styles$12.AnnotationDescription
  }, descriptionMarkup))), createElement("div", {
    className: styles$12.AnnotationContent
  }, children)));
}
...
function Section$4(_ref) {
  ...
  var className = classNames(styles$12.Section, secondary && styles$12['Section-secondary'], fullWidth && styles$12['Section-fullWidth'], oneHalf && styles$12['Section-oneHalf'], oneThird && styles$12['Section-oneThird']);
  return createElement("div", {
    className: className
  }, children);
}
...
function (_React$PureComponent) {
  ...
  _createClass(ContentList, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$13.List, type && styles$13[variationName('type', type)]);
...
function Indicator(_ref) {
  ...
  var className = classNames(styles$14.Indicator, pulse && styles$14.pulseIndicator);
  return createElement("span", {
    className: className
  });
}
...
function (_React$Component) {
  ...
  _createClass(BaseItem, [{
    ...
    value: function render() {
      ...
      if (url == null) {
        var _className = classNames(styles$15.Item, disabled && styles$15['Item-disabled']);

        return createElement("li", {
          className: styles$15.ListItem
      ...
      var secondaryActionMarkup = secondaryAction && createElement(UnstyledLink$1, {
        ...
        className: styles$15.SecondaryAction,
        tabIndex: tabIndex,
        "aria-disabled": disabled,
      ...
      var itemClassName = classNames(styles$15.Item, disabled && styles$15['Item-disabled'], selected && subNavigationItems.length === 0 && styles$15['Item-selected'], showExpanded && styles$15.subNavigationActive);
      ...
      if (subNavigationItems.length > 0 && showExpanded) {
        ...
        secondaryNavigationMarkup = createElement("div", {
          className: styles$15.SecondaryNavigation
      ...
      var className = classNames(styles$15.ListItem, secondaryAction && styles$15['ListItem-hasAction']);
      return createElement("li", {
        className: className
...
function (_React$Component) {
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      var expanded = this.state.expanded;
      var className = classNames(styles$15.Section, separator && styles$15['Section-withSeparator'], fill && styles$15['Section-fill']);
      var actionMarkup = action && createElement("button", {
        type: "button",
        className: styles$15.Action,
      ...
      var sectionHeadingMarkup = title && createElement("li", {
        className: styles$15.SectionHeading
      }, createElement("span", {
        className: styles$15.Text
      }, title), actionMarkup);
      ...
      var toggleClassName = classNames(styles$15.Item, styles$15.RollupToggle);
      ...
      var activeItemsMarkup = rollup && additionalItems.length > 0 && createElement("li", {
        className: styles$15.RollupSection
...
function Message(_ref) {
  ...
  return createElement("div", {
    ...
    url: link.to
  }, link.content), createElement(Button$2, {
    onClick: action.onClick,
    plain: true
  }, action.content)));
}
...
function MessageIndicator(_ref) {
  ...
  var indicatorMarkup = active && createElement("div", {
    className: styles$17.MessageIndicator
  });
  return createElement("div", {
    className: styles$17.MessageIndicatorWrapper
...
function (_React$PureComponent) {
  ...
  _createClass(UserMenu, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$18.UserMenu, userMenuExpanded && styles$18.expanded);
      var itemClassName = styles$18.Item;
      var tabIndex = userMenuExpanded ? 0 : -1;
      var itemsMarkup = actions && actions.map(function (section) {
        return createElement("div", {
          className: styles$18.Section,
          key: section.id
        }, section.items.map(function (item) {
          var icon = item.icon;
          return item.url ? createElement(UnstyledLink$1, {
            url: item.url,
            key: item.content,
            className: itemClassName,
            tabIndex: tabIndex,
            ...
            source: icon
          })), item.content) : createElement("button", {
            type: "button",
            key: item.content,
      ...
      var messageMarkup = message && createElement("div", {
        className: styles$18.Section
      ...
      return createElement("div", {
        ...
        type: "button",
        className: styles$18.Button,
        onClick: this.handleClick,
        onMouseUp: handleMouseUp$1
      }, createElement("span", {
        className: styles$18.Avatar
        ...
        className: styles$18.Details
      }, createElement("span", {
        className: styles$18.Name
      }, name), createElement("span", {
        className: styles$18.Detail
      }, detail)), createElement("span", {
        className: styles$18.DisclosureIcon
      }, createElement(Icon$1, {
        source: "chevronDown",
        color: "inkLightest",
        accessibilityLabel: "Show user menu"
      }))), createElement("div", {
        className: styles$18.List,
...
__decorate([memoize()], UserMenu.prototype, "createActionHandler", null);

__decorate([autobind], UserMenu.prototype, "handleClick", null);
...
function (_React$Component) {
  ...
  _createClass(Navigation, [{
    ...
    value: function render() {
      ...
      return createElement("nav", {
        className: styles$15.Navigation
      }, createElement("div", {
        className: styles$15.UserMenu
      }, userMenu), createElement(Scrollable$1, {
        className: styles$15.PrimaryNavigation
      }, children));
    }
  }]);
...
function (_React$PureComponent) {
  ...
  _createClass(TooltipOverlay, [{
    ...
    value: function renderTooltip(overlayDetails) {
      ...
      var containerClassName = classNames(styles$19.Tooltip, light && styles$19.light, measuring && styles$19.measuring, positioning === 'above' && styles$19.positionedAbove);
      var contentStyles = measuring ? undefined : {
...
function Pagination(_ref) {
  ...
  var className = classNames$1(styles$1a.Pagination, plain && styles$1a.plain);
...
function Action(_ref) {
  ...
  var className = classNames$1(styles$1b.Action, disabled && styles$1b.disabled, icon && children == null && styles$1b.iconOnly);
  return createElement("button", {
    key: children,
    className: className,
    onClick: onAction,
  ...
  _createClass(ActionGroup, [{
    ...
    value: function render() {
      ...
      var detailsMarkup = details && createElement("div", {
        className: styles$1c.Details
      }, details);
      return createElement("div", {
        className: styles$1c.ActionGroup,
...
function (_React$PureComponent) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1d.Header, titleHidden && styles$1d['Title-hidden'], pagination && styles$1d['Header-hasPagination'], separator && styles$1d['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$1d['Header-hasBreadcrumbs'], this.hasRollup && styles$1d['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$1d['Header-hasSecondaryActions']);
      ...
      var titleMarkup = createElement("div", {
        className: styles$1d.TitleAndRollup
      }, createElement("div", {
        className: styles$1d.Title
      ...
      return primaryActionMarkup ? createElement("div", {
        ...
        className: styles$1d.MainContent
      }, createElement("div", {
        className: styles$1d.TitleAndActions
    ...
    value: function renderSecondaryActions() {
      ...
      var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref, index) {
        var title = _ref.title,
            ...
            details = _ref.details;
        return createElement("div", {
          className: styles$1d.IndividualAction,
      ...
      return createElement("div", {
        className: styles$1d.SecondaryActions
      }, createElement("div", {
        className: styles$1d.IndividualActions
...
function (_React$PureComponent) {
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1e.Page, fullWidth && styles$1e.fullWidth, singleColumn && styles$1e.singleColumn);
      var headerMarkup = this.props.polaris.appBridge || this.hasHeaderContent() === false ? null : createElement(Header$3, rest);
      return createElement("div", {
        className: className
      }, headerMarkup, createElement("div", {
...
function PageActions(_ref) {
  ...
  return createElement("div", {
    className: styles$1f.PageActions
  }, createElement(Stack, {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function render() {
      ...
      var outputMarkup = !disabled && output && createElement("output", {
        htmlFor: id,
        className: styles$1g.Output
      }, createElement("div", {
        className: styles$1g.OutputBubble
      }, createElement("span", {
        className: styles$1g.OutputText
      }, value)));
      var prefixMarkup = prefix && createElement("div", {
        className: styles$1g.Prefix
      }, prefix);
      var suffixMarkup = suffix && createElement("div", {
        className: styles$1g.Suffix
      }, suffix);
      var className = classNames(styles$1g.RangeSlider, error && styles$1g.error, disabled && styles$1g.disabled);
      return createElement(Labelled, {
        id: id,
        label: label,
        error: error,
        ...
        className: styles$1g.InputWrapper
      }, createElement("input", {
        type: "range",
...
function Select(_ref) {
  ...
  var className = classNames(styles$1h.Select, error && styles$1h.error, disabled && styles$1h.disabled);
  ...
  var inlineLabelMarkup = labelInline && createElement("span", {
    className: styles$1h.InlineLabel
  }, label);
  ...
  var contentMarkup = createElement("div", {
    ...
    className: styles$1h.SelectedOption
...
function CheckableButton(_ref) {
  var accessibilityLabel = _ref.accessibilityLabel,
      ...
      disabled = _ref.disabled;
  var className = plain ? classNames(styles$1i.CheckableButton, styles$1i['CheckableButton-plain']) : classNames(styles$1i.CheckableButton, selectMode && styles$1i['CheckableButton-selectMode'], selected && styles$1i['CheckableButton-selected'], measuring && styles$1i['CheckableButton-measuring']);
  return createElement("div", {
    className: className,
    onClick: onToggleAll
  }, createElement("div", {
    className: styles$1i.Checkbox
  ...
  _createClass(BulkActionButton, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          disabled = _this$props.disabled;
      var disclosureIconMarkup = disclosure ? createElement("span", {
        className: styles$1j.ActionIcon
      }, createElement(Icon$1, {
        source: "caretDown"
      })) : null;
      var contentMarkup = disclosureIconMarkup ? createElement("span", {
        className: styles$1j.ActionContent
      ...
      var className = classNames$1(styles$1j.Button, disabled && styles$1j.disabled);
      return createElement("button", {
        className: className,
        onClick: onAction,
        onMouseUp: handleMouseUpByBlurring,
...
var slideClasses = {
  appear: classNames(styles$1j.Slide, styles$1j['Slide-appear']),
  appearActive: classNames(styles$1j.Slide, styles$1j['Slide-appearing']),
  enter: classNames(styles$1j.Slide, styles$1j['Slide-enter']),
  enterActive: classNames(styles$1j.Slide, styles$1j['Slide-entering']),
  exit: classNames(styles$1j.Slide, styles$1j['Slide-exit'])
};
var BulkActions =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(BulkActions, [{
    ...
    value: function render() {
      ...
      var paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? createElement("div", {
        className: styles$1j.PaginatedSelectAll
      }, paginatedSelectAllTextMarkup, " ", paginatedSelectAllActionMarkup) : null;
      var cancelButtonClassName = classNames(styles$1j.Button, styles$1j['Button-cancel']);
      ...
      var smallScreenGroup = createElement(Transition, {
        ...
        var smallScreenGroupClassName = classNames(styles$1j.Group, styles$1j['Group-smallScreen'], styles$1j["Group-".concat(status)]);
        return createElement("div", {
          className: smallScreenGroupClassName
        }, createElement("div", {
          className: styles$1j.ButtonGroup
        }, createElement(CSSTransition, {
          in: selectMode,
          timeout: Duration.Base,
      ...
      var largeScreenGroup = createElement(Transition, {
        ...
        var largeScreenGroupClassName = classNames(styles$1j.Group, styles$1j['Group-largeScreen'], !measuring && styles$1j["Group-".concat(status)], measuring && styles$1j['Group-measuring']);
        return createElement("div", {
...
function Tag(_ref) {
  var children = _ref.children,
      ...
      intl = _ref.polaris.intl;
  var className = classNames$1(disabled && styles$1k.disabled, styles$1k.Tag);
  ...
  _createClass(DateSelector, [{
    ...
    value: function render() {
      ...
      var datePredicateMarkup = showDatePredicate && createElement(Fragment, null, createElement("div", {
        className: styles$1l.DateTextField
        ...
        className: styles$1l.DatePicker
    ...
    value: function render() {
      ...
      switch (filter.type) {
        ...
        case FilterType.TextField:
          return createElement(Stack, {
            vertical: true
          }, operatorOptionsMarkup, createElement(TextField, {
            label: selectedFilterLabel,
            value: value,
  ...
  _createClass(FilterControl, [{
    ...
    value: function render() {
      ...
      var appliedFiltersMarkup = appliedFilters.map(function (appliedFilter) {
        ...
        return createElement("li", {
          className: styles$1m.AppliedFilter,
          key: filterId
        }, createElement(Tag$1, {
      ...
      var appliedFiltersWrapper = appliedFilters.length > 0 ? createElement("ul", {
        className: styles$1m.AppliedFilters
      }, appliedFiltersMarkup) : null;
      return createElement(FormLayout, null, createElement(TextField, {
...
function (_React$PureComponent) {
  ...
  _createClass(Item, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1n.Item, focused && styles$1n.focused, selectable && styles$1n.selectable, selected && styles$1n.selected, selectMode && styles$1n.selectMode, persistActions && styles$1n.persistActions, focusedInner && styles$1n.focusedInner);
  ...
  _createClass(ResourceList, [{
    ...
    value: function render() {
      ...
      var filterControlMarkup = filterControl ? createElement("div", {
        className: styles$1o.FiltersWrapper
      }, filterControl) : null;
      var bulkActionsMarkup = this.selectable ? createElement("div", {
        className: styles$1o.BulkActionsWrapper
      ...
      var sortingSelectMarkup = sortOptions && sortOptions.length > 0 && !alternateTool ? createElement("div", {
        className: styles$1o.SortWrapper
      ...
      var alternateToolMarkup = alternateTool && !sortingSelectMarkup ? createElement("div", {
        className: styles$1o.AlternateToolWrapper
      }, alternateTool) : null;
      var headerTitleMarkup = createElement("div", {
        className: styles$1o.HeaderTitleWrapper
      }, this.headerTitle);
      var selectButtonMarkup = this.selectable ? createElement("div", {
        className: styles$1o.SelectButtonWrapper
      }, createElement(Button$2, {
        disabled: selectMode,
      ...
      var checkableButtonMarkup = this.selectable ? createElement("div", {
        className: styles$1o.CheckableButtonWrapper
      ...
      var headerWrapperOverlay = loading ? createElement("div", {
        className: styles$1o['HeaderWrapper-overlay']
      }) : null;
      var headerMarkup = (showHeader || needsHeader) && this.listRef.current && createElement("div", {
        className: styles$1o.HeaderOuterWrapper
      }, createElement(Sticky, {
        boundingElement: this.listRef.current
      }, function (isSticky) {
        var headerClassName = classNames(styles$1o.HeaderWrapper, sortOptions && sortOptions.length > 0 && !alternateTool && styles$1o['HeaderWrapper-hasSort'], alternateTool && styles$1o['HeaderWrapper-hasAlternateTool'], _this2.selectable && styles$1o['HeaderWrapper-hasSelect'], loading && styles$1o['HeaderWrapper-disabled'], _this2.selectable && selectMode && styles$1o['HeaderWrapper-inSelectMode'], isSticky && styles$1o['HeaderWrapper-isSticky']);
        return createElement("div", {
          className: headerClassName
        }, headerWrapperOverlay, createElement("div", {
          className: styles$1o.HeaderContentWrapper
      ...
      var emptyStateMarkup = filterControl && !this.itemsExist() && !loading ? createElement("div", {
        className: styles$1o.EmptySearchResultWrapper
      ...
      var loadingOverlay = loading ? createElement(Fragment, null, createElement("div", {
        className: styles$1o.SpinnerContainer,
        style: spinnerStyle
      }, createElement(Spinner$1, {
        size: spinnerSize,
        accessibilityLabel: "Items are loading"
      })), createElement("div", {
        className: styles$1o.LoadingOverlay
      })) : null;
      var className = classNames(styles$1o.ItemWrapper, loading && styles$1o['ItemWrapper-isLoading']);
      var loadingWithoutItemsMarkup = loading && !this.itemsExist() ? createElement("div", {
        className: className,
        tabIndex: -1
      }, loadingOverlay) : null;
      var resourceListClassName = classNames(styles$1o.ResourceList, loading && styles$1o.disabledPointerEvents);
      ...
      return createElement(Provider$2, {
        ...
        className: styles$1o.ResourceListWrapper
    ...
    value: function renderItem(item, index) {
      ...
      return createElement("li", {
        key: id,
        className: styles$1o.ItemWrapper
      }, renderItem(item, id));
    }
  }, {
...
function (_React$PureComponent) {
  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$1p.Tab, selected && styles$1p['Tab-selected']);
      var tabIndex;
      ...
      return createElement("li", {
        role: "presentation",
        className: styles$1p.TabContainer,
        ref: this.setNode
      }, markup);
    }
  }, {
...
function (_React$PureComponent) {
  ...
  _createClass(TabMeasurer, [{
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1p.Tabs, styles$1p.TabMeasurer);
      return createElement("div", {
        className: classname,
        ref: this.setContainerNode
      }, createElement(EventListener, {
...
function (_React$PureComponent) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var classname = classNames(styles$1p.Tabs, fitted && styles$1p.fitted, disclosureActivatorVisible && styles$1p.fillSpace);
      var disclosureTabClassName = classNames(styles$1p.DisclosureTab, disclosureActivatorVisible && styles$1p['DisclosureTab-visible']);
      var activator = createElement("button", {
        tabIndex: -1,
        className: styles$1p.DisclosureActivator,
    ...
    value: function handleFocus(event) {
      ...
      if (target.classList.contains(styles$1p.Tab) || target.classList.contains(styles$1p.Item)) {
        var tabToFocus = -1;
      ...
      if (target.classList.contains(styles$1p.DisclosureActivator)) {
        return;
      ...
      if (!relatedTarget.classList.contains(styles$1p.Tab) && !relatedTarget.classList.contains(styles$1p.Item) && !relatedTarget.classList.contains(styles$1p.DisclosureActivator)) {
        this.setState({
          tabToFocus: selected
        });
      }
...
function Thumbnail(_ref) {
  var source = _ref.source,
      ...
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 'medium' : _ref$size;
  var className = classNames(styles$1q.Thumbnail, size && styles$1q[variationName('size', size)]);
  return createElement("span", {
    className: className
  }, createElement(Image, {
    alt: alt,
    source: source,
    className: styles$1q.Image
  }));
}
  ...
  _createClass(Toast, [{
    ...
    value: function componentDidMount() {
      ...
      if (appBridge == null) {
        ...
        this.appBridgeToast = Flash.create(appBridge, {
          message: content,
          duration: duration,
          isError: error,
          isDismissible: true
        });
        this.appBridgeToast.subscribe(Flash.Action.CLEAR, onDismiss);
        this.appBridgeToast.dispatch(Flash.Action.SHOW);
      }
    }
  }, {
    key: "componentWillUnmount",
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          children = _this$props.children;
      var searchClassName = classNames(styles$1r.Search, visible && styles$1r.visible);
      return createElement("div", {
        ref: this.node,
        className: searchClassName,
        onClick: this.handleDismiss
      }, createElement("div", {
        className: styles$1r.Overlay
      }, children));
    }
  }, {
    key: "handleDismiss",
  ...
  _createClass(SearchField, [{
    ...
    value: function render() {
      ...
      var clearMarkup = value !== '' && createElement("button", {
        type: "button",
        "aria-label": "Clear",
        className: styles$1s.Clear,
        onClick: this.handleClear
      }, createElement(Icon$1, {
        source: "circleCancel"
      }));
      var className = classNames(styles$1s.SearchField, (focused || active) && styles$1s.focused);
      return createElement("div", {
        className: className,
        onFocus: this.handleFocus,
        onBlur: this.handleBlur
...
function Menu(props) {
  ...
  var messageMarkup = message && createElement(Message$1, {
    title: message.title,
    description: message.description,
    action: {
      onClick: message.action.onClick,
...
function UserMenu$1(_ref) {
  ...
  var activatorContentMarkup = createElement("div", {
    ...
    className: styles$1v.Details
  }, createElement("p", {
    className: styles$1v.Name,
    title: "altText"
  }, name), createElement("p", {
    className: styles$1v.Detail
  }, detail)));
  ...
  _createClass(TopBar, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          logo = _this$props.polaris.theme.logo;
      var focused = this.state.focused;
      var className = classNames(styles$1w.NavigationIcon, focused && styles$1w.focused);
      ...
      var width = getWidth(logo, 104);
      var logoMarkup = logo ? createElement(UnstyledLink$1, {
        url: logo.url || '',
        className: styles$1w.LogoLink,
        style: {
          width: width
        }
      }, createElement(Image, {
      ...
      return createElement("div", {
        className: styles$1w.TopBar
      }, navigationButtonMarkup, createElement("div", {
        className: styles$1w.LogoContainer
      }, logoMarkup), createElement("div", {
        className: styles$1w.Contents
...
function ProgressBar(_ref) {
  var _ref$progress = _ref.progress,
      ...
      size = _ref$size === void 0 ? 'medium' : _ref$size,
      intl = _ref.polaris.intl;
  var className = classNames(styles$1A.ProgressBar, size && styles$1A[variationName('size', size)]);
